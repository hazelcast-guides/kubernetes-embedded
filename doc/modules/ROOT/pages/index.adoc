...
[TIP]
====
You can use any other JVM-based application framework, but make sure your project includes a dependency to `hazelcast:hazelcast-all:${hazelcast.version}` (or `hazelcast:hazelcast-kubernetes:${hazelcast-kubernetes.version`).
====
