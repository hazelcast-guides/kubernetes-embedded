:github-address: https://github.com/hazelcast-guides/kubernetes-embedded
...
You can embed Hazelcast into any JVM-based application and use any web framework you want. As the sample for this guide, let's use the application from xref:hazelcast-embedded-springboot:ROOT:index.adoc[Getting Started with Hazelcast using Spring Boot] guide. To download it, execute the following command.
